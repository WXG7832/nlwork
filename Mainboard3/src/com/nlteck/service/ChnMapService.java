...
public class ChnMapService {
	...
	public ChnMapService() {
		...
		try {
			logger = LogUtil.createLog("log/chnMapService.log");
	...
	public void loadXml() {
		...
		List<Element> chnEles = root.elements("chn");
		for (Element ele : chnEles) {
			...
			mapChnIndex(deviceChnIndex, mapChnIndex);
		}
	}
	 ...
	 * @return
	 */
	public int mapChnIndex(int deviceChnIndex) {

		Integer mapChnIndex = map.get(deviceChnIndex);
		if (mapChnIndex == null) {
	 ...
	 * @return
	 */
	public int findDeviceChnIndexByMap(int mapChnIndex) {

		Optional<Integer> op = map.entrySet().stream().filter(x -> x.getValue().equals(mapChnIndex))
	...
	public void mapChnIndex(int deviceChnIndex, int mapChnIndex) {
		...
		map.put(deviceChnIndex, mapChnIndex);
	 ...
	 */
	public void mapChnIndexs(List<Entry<Integer, Integer>> mapEntrys) {
