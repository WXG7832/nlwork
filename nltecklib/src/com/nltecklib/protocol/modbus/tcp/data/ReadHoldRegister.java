...
/**
 * 
 * @ClassName ReadHoldRegister
 * @Description ¶Á³Ö¾ÃÐÍ¼Ä´æÆ÷
 */
public class ReadHoldRegister implements Data{
	
	private Integer address;
	private Integer count;
	
	public ReadHoldRegister() {
		super();
	}

	public ReadHoldRegister(Integer address, Integer count) {
		super();
	...
	public String decoder(String hex) {
		...
		if (func.equals(Fun.READ_HOLD_REGISTER.getCode())) {
	...
	@Override
	public byte[] encoder() {
		String hex = SLAVE_ID + Fun.READ_HOLD_REGISTER.getCode() + String.format("%04x", (int)address) + String.format("%04x", (int)count);
