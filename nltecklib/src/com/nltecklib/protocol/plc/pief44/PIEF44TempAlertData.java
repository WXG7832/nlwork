 ...
 *
 */
public class PIEF44TempAlertData extends PlcData{
	
	private static final int DEFAULT_IC_ADDRESS = 2500;
	private static final int DEFAULT_AG_ADDRESS = 2512;
	...
	public PIEF44TempAlertData(int fixtureIndex, int dataLength, boolean isRead) {
		super();
		area = DEFAULT_AREA;		// 默认地址区域
		address = DEFAULT_IC_ADDRESS;	//地址
