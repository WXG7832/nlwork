 ...
 *
 */
public class PIEF44PrePressBackAddrData extends PlcData{
	
	private static final int DEFAULT_IC_ADDRESS = 4100;
	private static final int DEFAULT_AG_ADDRESS = 4600;
	...
	public PIEF44PrePressBackAddrData() {
		super();
	...
	public PIEF44PrePressBackAddrData(int fixtureIndex, int dataLength, boolean isRead) {
		super();
		area = DEFAULT_AREA;		// 默认地址区域
		address = DEFAULT_IC_ADDRESS;	//地址
