 ...
 *
 */
public class PIEF44FirstSpeedBackAddrData extends PlcData{
	
	private static final int DEFAULT_IC_ADDRESS = 4120;
	private static final int DEFAULT_AG_ADDRESS = 4620;
	...
	public PIEF44FirstSpeedBackAddrData() {
		super();
	...
	public PIEF44FirstSpeedBackAddrData(int fixtureIndex, int dataLength, boolean isRead) {
		super();
		area = DEFAULT_AREA;		// 默认地址区域
		address = DEFAULT_IC_ADDRESS;	//地址
