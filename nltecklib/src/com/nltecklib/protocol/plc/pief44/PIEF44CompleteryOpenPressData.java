 ...
 *
 */
public class PIEF44CompleteryOpenPressData extends PlcData{
	
	private static final int DEFAULT_IC_ADDRESS = 4150;
	private static final int DEFAULT_AG_ADDRESS = 4650;
	...
	public PIEF44CompleteryOpenPressData() {
		super();
	...
	public PIEF44CompleteryOpenPressData(int fixtureIndex, int dataLength, boolean isRead) {
		super();
		area = DEFAULT_AREA;		// 默认地址区域
		address = DEFAULT_IC_ADDRESS;	//地址
