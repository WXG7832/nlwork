 ...
 *
 */
public class PIEF44FifthSpeedAddrData extends PlcData{
	
	private static final int DEFAULT_IC_ADDRESS = 4030;
	private static final int DEFAULT_AG_ADDRESS = 4530;
	...
	public PIEF44FifthSpeedAddrData() {
		super();
	...
	public PIEF44FifthSpeedAddrData(int fixtureIndex, int dataLength, boolean isRead) {
		super();
		area = DEFAULT_AREA;		// 默认地址区域
		address = DEFAULT_IC_ADDRESS;	//地址
