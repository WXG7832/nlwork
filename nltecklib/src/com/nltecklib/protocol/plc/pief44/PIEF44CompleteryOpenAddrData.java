 ...
 *
 */
public class PIEF44CompleteryOpenAddrData extends PlcData{
	
	private static final int DEFAULT_IC_ADDRESS = 4140;
	private static final int DEFAULT_AG_ADDRESS = 4640;
	...
	public PIEF44CompleteryOpenAddrData() {
		super();
	...
	public PIEF44CompleteryOpenAddrData(int fixtureIndex, int dataLength, boolean isRead) {
		super();
		area = DEFAULT_AREA;		// 默认地址区域
		address = DEFAULT_IC_ADDRESS;	//地址
