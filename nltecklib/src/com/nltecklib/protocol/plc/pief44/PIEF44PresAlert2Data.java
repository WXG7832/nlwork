 ...
 *
 */
public class PIEF44PresAlert2Data extends PlcData{
	
	private static final int DEFAULT_IC_ADDRESS = 3100;
	private static final int DEFAULT_AG_ADDRESS = 3600;
	...
	public PIEF44PresAlert2Data(int fixtureIndex, int dataLength, boolean isRead) {
		super();
		area = DEFAULT_AREA;		// 默认地址区域
		address = DEFAULT_IC_ADDRESS;	//地址
