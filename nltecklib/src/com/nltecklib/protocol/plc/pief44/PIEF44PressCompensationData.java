 ...
 *
 */
public class PIEF44PressCompensationData extends PlcData{
	
	private static final int DEFAULT_IC_ADDRESS = 4160;
	private static final int DEFAULT_AG_ADDRESS = 4660;
	...
	public PIEF44PressCompensationData() {
		super();
	...
	public PIEF44PressCompensationData(int fixtureIndex, int dataLength, boolean isRead) {
		super();
		area = DEFAULT_AREA;		// 默认地址区域
		address = DEFAULT_IC_ADDRESS;	//地址
