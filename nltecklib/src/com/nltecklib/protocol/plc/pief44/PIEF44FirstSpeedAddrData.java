 ...
 *
 */
public class PIEF44FirstSpeedAddrData extends PlcData{
	
	private static final int DEFAULT_IC_ADDRESS = 4020;
	private static final int DEFAULT_AG_ADDRESS = 4520;
	...
	public PIEF44FirstSpeedAddrData() {
		super();
	...
	public PIEF44FirstSpeedAddrData(int fixtureIndex, int dataLength, boolean isRead) {
		super();
		area = DEFAULT_AREA;		// 默认地址区域
		address = DEFAULT_IC_ADDRESS;	//地址
