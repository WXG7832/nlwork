 ...
 *
 */
public class PIEF44ICPresAlertData2 extends PlcData{
	
	private static final int DEFAULT_IC_ADDRESS = 4500;
	...
	public PIEF44ICPresAlertData2(int fixtureIndex, int dataLength, boolean isRead) {
		super();
		area = DEFAULT_AREA;		// 默认地址区域
		address = DEFAULT_IC_ADDRESS;	//地址
