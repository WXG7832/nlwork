...
public class CalToolsTestLoadSwitchData extends Data implements Configable, Queryable, Responsable {
	...
	public Code getCode() {
		// TODO Auto-generated method stub
		return CalToolsTestCode.LoadSwitchCode;
	}

	@Override
	public String toString() {
		return "CalToolsTestLoadSwitchData [on=" + on + "]";
	}
