...
public class CalToolsTestChnSelectData extends Data implements Configable, Queryable, Responsable {
	...
	public Code getCode() {
		// TODO Auto-generated method stub
		return CalToolsTestCode.ChnSelectCode;
	}

	@Override
	public String toString() {
		return "CalToolsTestChnSelectData [on=" + on + "]";
	}
