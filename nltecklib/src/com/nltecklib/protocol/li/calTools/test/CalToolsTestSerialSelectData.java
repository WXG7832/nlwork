...
public class CalToolsTestSerialSelectData extends Data implements Configable, Queryable, Responsable {
	...
	public Code getCode() {
		// TODO Auto-generated method stub
		return CalToolsTestCode.SerialSelectCode;
	}

	@Override
	public String toString() {
		return "CalToolsTestSerialSelectData [on=" + on + "]";
	}
