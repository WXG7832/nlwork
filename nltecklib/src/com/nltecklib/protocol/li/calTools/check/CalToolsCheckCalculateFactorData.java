...
public class CalToolsCheckCalculateFactorData extends Data implements Configable, Queryable, Responsable {

	private Map<Pole, List<CalDot>> calDotMap = new HashMap<Pole, List<CalDot>>();

	public CalToolsCheckCalculateFactorData() {
	...
	public Code getCode() {
		// TODO Auto-generated method stub
		return CalToolsCheckCode.CalFactorCode;
	}
