 ...
 */
public class SelfCheckData extends Data implements Configable, Queryable, Responsable {
	...
	public String toString() {
		return "SelfCheckData [state=" + state + ", date=" + date + "]";
	}
