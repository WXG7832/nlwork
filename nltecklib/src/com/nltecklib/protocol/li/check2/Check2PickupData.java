...
import com.nltecklib.protocol.li.check2.Check2Environment.ChnState;
import com.nltecklib.protocol.li.check2.Check2Environment.PowerState;
import com.nltecklib.protocol.util.ProtocolUtil;

public class Check2PickupData extends Data implements Queryable, Responsable {

	private PowerState powerState = PowerState.POWEROFF;
	private CheckWorkMode workMode = CheckWorkMode.CHECK;
	private List<ChnData> chnDatas = new LinkedList<ChnData>();

	public static class ChnData {
		...
		public String toString() {
			return "ChnData [chnState=" + chnState + ", deviceVoltage=" + deviceVoltage + ", powerVoltage="
					+ powerVoltage + ", alertCode=" + alertCode + ", alertVoltage=" + alertVoltage + "]";
		}
	...
	public void decode(List<Byte> encodeData) {
		...
		if (modeIndex > CheckWorkMode.values().length - 1) {

			throw new RuntimeException("error workmode index :" + modeIndex);
		}
		workMode = CheckWorkMode.values()[modeIndex];
