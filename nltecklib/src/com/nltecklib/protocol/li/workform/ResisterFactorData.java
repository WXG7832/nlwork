...
public class ResisterFactorData extends Data implements Queryable, Responsable {
...
//	private final static int EXP = 8; // 小数位精度
	...
	public void setHighResisterFactor(double highResisterFactor) {
		this.highResisterFactor = highResisterFactor;
	}
