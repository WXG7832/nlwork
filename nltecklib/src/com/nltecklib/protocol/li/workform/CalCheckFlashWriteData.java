 ...
 *
 */
public class CalCheckFlashWriteData extends Data implements Configable, Queryable, Responsable {
	...
	public static final int B_BIT_COUNT = 6;
	...
	public Code getCode() {
		...
		return  WorkformCode.CheckFlashWriteCode;
	}
