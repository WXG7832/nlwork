...
public class CheckCalculateDebugData extends Data implements Configable, Queryable, Responsable {
	...
	public Code getCode() {
		// TODO Auto-generated method stub
		return PCWorkformCode.CheckCalculateDebugCode;
	}

	@Override
	public String toString() {
		return "CheckCalculateDebugData [pole=" + pole + ", voltMode=" + voltMode + ", work=" + work + ", adcs=" + adcs
				+ "]";
	}
