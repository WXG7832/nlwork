...
/**
* @author  wavy_zheng
* @version 创建时间：2022年2月19日 下午3:49:28
* 单步写入flash调试协议
*/
public class LogicFlashWrite2DebugData extends Data implements Configable, Queryable, Responsable {
	...
	public Code getCode() {
		// TODO Auto-generated method stub
		return PCWorkformCode.LogicFlashWrite2Code;
	}
	...
	public String toString() {
		return "LogicFlashWrite2DebugData [moduleIndex=" + moduleIndex + ", kb_dotMap=" + kb_dotMap + ", cv1DotCount="
