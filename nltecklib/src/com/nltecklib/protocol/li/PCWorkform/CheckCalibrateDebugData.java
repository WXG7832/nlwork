 ...
 *
 */
public class CheckCalibrateDebugData extends Data implements Configable, Queryable, Responsable {
	...
	public CheckCalibrateDebugData() {
	...
	public Code getCode() {
		...
		return PCWorkformCode.CheckCalibrateDebugCode;
	}
	...
	public String toString() {
		return "CheckCalibrateDebugData [pole=" + pole + ", voltMode=" + voltMode + ", work=" + work + ", adcs=" + adcs
				+ "]";
	}
