 ...
 *
 */
public class CalMatchData extends Data implements Configable, Queryable, Responsable {
	...
	public Code getCode() {
		...
		return PCWorkformCode.CalMatchCode;
	}
	...
	public String toString() {
		return "CalMatchData [adcList=" + adcList + "]";
	}
