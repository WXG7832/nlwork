...
/**
* @author  wavy_zheng
* @version 创建时间：2020年10月30日 上午10:19:10
* 计量方案
*/
public class CalculatePlanData extends Data implements Configable, Queryable, Responsable {
	...
	private List<CalculatePlanMode> modes = new ArrayList<>();
	...
	public void setModes(List<CalculatePlanMode> modes) {
		this.modes = modes;
	}
	...
	public void encode() {
		...
		for(CalculatePlanMode mode : modes) {
	...
	public void decode(List<Byte> encodeData) {
        ...
        for(int n = 0 ; n < count ; n++) {
        	...
        	CalculatePlanMode pm = new CalculatePlanMode();
	...
	public void  addCalculateMode(CalculatePlanMode  mode ) {
	...
	public List<CalculatePlanMode> getModes() {
		return modes;
	}
