...
public class LogicCalProcessData extends Data implements Configable, Queryable, Responsable {
	...
	private byte ready;
	private boolean highPrecision; //默认高精度
	private double primitiveADC;
	private double finalADC;
	
	public LogicCalProcessData() {
	...
	public void encode() {
		...
		if (isDoubleResolutionSupport()) {
			data.add((byte) (highPrecision ? 1 : 0));
		}
		// 程控电压
	...
	public void decode(List<Byte> encodeData) {
		...
		if (isDoubleResolutionSupport()) {
			...
			highPrecision = ProtocolUtil.getUnsignedByte(data.get(index++)) == 1;
	...
	public String toString() {
		return "LogicCalProcessData [pole=" + pole + ", workMode=" + workMode + ", programV=" + programV + ", programI="
				+ programI + ", subDA=" + subDA + ", chnIndex=" + chnIndex + ", ready=" + ready + ", highPrecision="
				+ highPrecision + ", primitiveADC=" + primitiveADC + ", finalADC=" + finalADC + "]";
	}
