 ...
 */
@Deprecated
public class MBSelfCheckData extends Data implements Configable, Queryable, Responsable {
	...
	public Code getCode() {
		...
		return MBWorkformCode.SelfCheckCode;
	}
	...
	public String toString() {
		return "MBSelfCheckData [state=" + state + ", date=" + date + "]";
	}
