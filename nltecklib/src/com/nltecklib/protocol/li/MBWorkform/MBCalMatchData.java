 ...
 *
 */
public class MBCalMatchData extends Data implements Configable, Queryable, Responsable {

	private List<AdcData> adcList = new ArrayList<AdcData>();

	public MBCalMatchData() {
	...
	public Code getCode() {
		...
		return MBWorkformCode.MatchCalCode;
	}
	...
	public String toString() {
		return "MBCalMatchData [adcList=" + adcList + "]";
	}
