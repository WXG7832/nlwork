 ...
 */
@Deprecated
public class FlowProtectData extends Data implements ComponentSupportable, Responsable, Configable, Queryable {
    ...
    @Override
    public Code getCode() {
	return MainCode.FLOW_PROTECT_CODE;
    }

    @Override
    public String toString() {
	return "FlowProtectData [componentCode=" + component + ", result=" + result + ", orient=" + orient + ", alertMax=" + alertMax + ", alertMin=" + alertMin + ", stopMax=" + stopMax + ", stopMin=" + stopMin + "]";
    }
