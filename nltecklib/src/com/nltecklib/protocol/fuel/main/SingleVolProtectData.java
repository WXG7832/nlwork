 ...
 */
@Deprecated
public class SingleVolProtectData extends Data implements Responsable, Configable, Queryable {
    ...
    @Override
    public Code getCode() {
	return MainCode.SINGLE_VOL_PROTECT_CODE;
    }

    @Override
    public String toString() {
	return "SingleVolProtectData [standard=" + standard + ", alert=" + alert + ", stop=" + stop + "]";
    }
