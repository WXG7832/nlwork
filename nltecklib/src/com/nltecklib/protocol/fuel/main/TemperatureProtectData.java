 ...
 */
@Deprecated
public class TemperatureProtectData extends Data implements ComponentSupportable, Responsable, Configable, Queryable {
    ...
    @Override
    public Code getCode() {
	return MainCode.TEMPERATURE_PROTECT_CODE;
    }

    @Override
    public String toString() {
	return "TemperatureProtectData [alertMax=" + alertMax + ", alertMin=" + alertMin + ", stopMax=" + stopMax + ", stopMin=" + stopMin + ", componentCode=" + component + ", result=" + result + ", orient=" + orient + "]";
    }
}
