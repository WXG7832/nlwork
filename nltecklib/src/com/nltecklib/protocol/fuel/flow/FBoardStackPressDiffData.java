 ...
 *
 */
public class FBoardStackPressDiffData extends Data implements Configable, Queryable, Responsable {
    ...
    @Override
    public Code getCode() {
	return FlowCode.STACK_PRESSURE_DIFFERENCE;
    }

    @Override
    public String toString() {
	return "FBoardStackPressDiff [stackPressDiff=" + stackPressDiff + "]";
    }
