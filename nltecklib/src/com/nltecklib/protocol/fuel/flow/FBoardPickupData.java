 ...
 *
 */
public class FBoardPickupData extends Data implements Responsable, Queryable {
	...
	@Override
	public Code getCode() {
		return FlowCode.PICK_UP_CODE;
	}

	@Override
	public String toString() {
		return "FBoardPickupData [keyValues=" + keyValues + ", keySwitchs=" + keySwitchs + ", keyAlertList="
				+ keyAlertList + "]";
	}
