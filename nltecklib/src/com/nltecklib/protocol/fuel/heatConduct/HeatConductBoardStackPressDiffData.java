 ...
 *
 */
public class HeatConductBoardStackPressDiffData extends Data implements Configable, Queryable, Responsable {
    ...
    @Override
    public Code getCode() {
	return HeatConductBoardFunctionCode.STACK_PRESSURE_DIFFERENCE;
    }

    @Override
    public String toString() {
	return "HeatConductBoardStackPressDiff [stackPressDiff=" + stackPressDiff + "]";
    }
