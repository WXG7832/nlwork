 ...
 *
 */
public class HeatConductBoardAlertClearData extends Data implements Configable, Responsable, Queryable {
	...
	@Override
	public Code getCode() {
		return HeatConductBoardFunctionCode.ALERT_CLEAR_CODE;
	}
