 ...
 *
 */
public class HeatConductBoardPIDData extends Data implements ComponentSupportable, Configable, Responsable, Queryable {
    private double p;
    private double i;
    private double d;
    ...
    @Override
    public Code getCode() {
	return HeatConductBoardFunctionCode.PID;
    }
