...
/**
 * 导热罐控制板，温度报警上限配置 0x0d
 * 
 * @author caichao_tang
 *
 */
public class HeatConductBoardTempUpLimitData extends Data implements ComponentSupportable, Configable, Queryable, Responsable {
    ...
    @Override
    public Code getCode() {
	return HeatConductBoardFunctionCode.TEMP_UP_LIMIT;
    }

    @Override
    public String toString() {
	return "HeatConductBoardTempUpLimit [tempUpLimit=" + tempUpLimit + "]";
    }
