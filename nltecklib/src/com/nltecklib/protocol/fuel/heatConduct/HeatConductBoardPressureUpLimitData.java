 ...
 *
 */
public class HeatConductBoardPressureUpLimitData extends Data implements ComponentSupportable, Configable, Queryable, Responsable {
    ...
    @Override
    public Code getCode() {
	return HeatConductBoardFunctionCode.PRESSURE_UP_LIMIT;
    }

    @Override
    public String toString() {
	return "HeatConductBoardPressureUpLimit [pressureUpLimit=" + pressureUpLimit + "]";
    }
