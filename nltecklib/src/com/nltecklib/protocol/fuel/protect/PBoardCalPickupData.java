 ...
 */
@Deprecated
public class PBoardCalPickupData extends Data implements BoardNoSupportable, ComponentSupportable, Responsable, Queryable {
    /**
     * on表示稳定,off不稳定
     */
    private State ready;
    ...
    @Override
    public Code getCode() {
	return ProtectCode.CAL_PICKUP_CODE;
    }

    @Override
    public String toString() {
	return "PBoardCalPickupData [ready=" + ready + ", adc=" + adc + ", boardNum=" + boardNum + ", componentCode=" + component + ", result=" + result + ", orient=" + orient + "]";
    }
