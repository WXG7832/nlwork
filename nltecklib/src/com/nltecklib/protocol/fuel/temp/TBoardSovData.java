 ...
 */
@Deprecated
public class TBoardSovData extends Data implements BoardNoSupportable, ComponentSupportable, Configable, Responsable, Queryable {
    ...
    @Override
    public Code getCode() {
	return TempCode.SOV_CODE;
    }

    @Override
    public String toString() {
	return "TBoardSovData [state=" + state + ", boardNum=" + boardNum + ", componentCode=" + component + "]";
    }
