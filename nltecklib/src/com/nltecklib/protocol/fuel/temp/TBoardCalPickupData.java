 ...
 */
@Deprecated
public class TBoardCalPickupData extends Data implements BoardNoSupportable, ComponentSupportable, Responsable, Queryable {
    /**
     * on表示稳定,off不稳定
     */
    private State ready;
	...
	data.addAll(Arrays.asList(adcData));
    }
    ...
    @Override
    public Code getCode() {
	return TempCode.CAL_PICKUP_CODE;
    }

    @Override
    public String toString() {
	return "TBoardCalPickupData [ready=" + ready + ", adc=" + adc + ", boardNum=" + boardNum + ", componentCode=" + component + ", result=" + result + ", orient=" + orient + "]";
    }
