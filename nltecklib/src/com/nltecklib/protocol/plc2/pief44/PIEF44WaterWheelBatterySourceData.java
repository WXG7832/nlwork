...
* @Description: 下料水车电芯来源夹具
* @author zhang_longyong  
* @date 2019年12月16日
 */
public class PIEF44WaterWheelBatterySourceData extends PlcData {
	
	private static final int DEFAULT_ADDRESS = 5055;
	private int number;
	...
	public PIEF44WaterWheelBatterySourceData() {
		super();
		area = Area.DM;		// 默认地址区域
	}
