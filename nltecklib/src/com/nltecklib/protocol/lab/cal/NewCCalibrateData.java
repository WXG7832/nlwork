...
public class NewCCalibrateData extends Data implements Queryable, Configable, Responsable {
	...
	public String toString() {
		return "NewCCalibrateData [workState=" + workState + ", workMode=" + workMode + ", readyState=" + readyState
