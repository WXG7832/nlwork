...
public class METERDOT_AD0 extends Data implements Configable, Queryable, Responsable {

    private double meterDot = 0;
    private byte chnCount = 1;
