...
public class FLASHDATA_N140MV extends Data implements Configable, Queryable, Responsable {

    private byte adc_kb_lst_count;
    private List<ADC_KB> adc_kb_lst = new LinkedList<ADC_KB>();

    public FLASHDATA_N140MV() {
	...
	return ADCalCode.FLASHDATA_N140MV;
    }
