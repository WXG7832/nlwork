...
public class CALDOT_P140MV extends Data implements Configable, Queryable, Responsable {

    private short da = 0; // 程控值
    private double adc = 0;

    public CALDOT_P140MV() {
	...
	return ADCalCode.CALDOT_P140MV;
    }
