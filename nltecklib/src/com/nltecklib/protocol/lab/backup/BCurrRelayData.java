 ...
 *
 */
public class BCurrRelayData extends Data implements Configable, Queryable, Responsable {
	...
	public Code getCode() {
		// TODO Auto-generated method stub
		return BackupCode.CurrDelayCode;
	}
	...
	public String toString() {
		return "CurrRelayData [connectState=" + connectState + "]";
	}
