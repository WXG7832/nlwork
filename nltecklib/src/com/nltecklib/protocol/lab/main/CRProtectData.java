...
public class CRProtectData extends Data implements Configable,Queryable,Responsable,Cloneable {
	...
	public String toString() {
		return "CRProtectData [voltUpper=" + voltUpper + ", voltLower=" + voltLower + ", currUpper=" + currUpper
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CRProtectData)) {
			return false;
		}
		CRProtectData other = (CRProtectData) obj;
