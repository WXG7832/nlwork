...
public class CalBackupVoltageMeterData extends Data implements Configable, Queryable, Responsable {
	...
	public Code getCode() {
		// TODO Auto-generated method stub
		return MainCode.CalBackupVoltageMeterCode;
	}

	@Override
	public String toString() {
		return "CalBackupVoltageMeterData [workMode=" + workMode + ", calculateValue=" + calculateValue + ", adcK="
				+ adcK + ", adcB=" + adcB + ", adcVals=" + adcVals + "]";
	}
