...
public class CPProtectData extends Data implements Configable,Queryable,Responsable,Cloneable {
	...
	public String toString() {
		return "CPProtectData [voltUpper=" + voltUpper + ", voltLower=" + voltLower + ", currUpper=" + currUpper
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof CPProtectData)) {
			return false;
		}
		CPProtectData other = (CPProtectData) obj;
