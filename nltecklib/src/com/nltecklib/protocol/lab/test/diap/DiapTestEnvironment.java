...
public class DiapTestEnvironment {
	...
	public enum DiapTestCode implements Code {
		...
		DiapPowerConfig(0X01), WorkPatternConfig(0x02), PowerItemConfig(0x03), Power16VSwitch(0x04), DiapControlSwitch(
				0x05), MultiReadchannelSelect(
						0x06), InformationCollection(0x07), PowerSwitch(0x08), CurrQuery(0x09), CheckResult(0x0A), DiapTemperCheck(0x0B),
		BurnState(0x0C);
	...
	public enum WorkPattern0x02Mode {

		Sleep, CCPositiveNormal, CCPositiveHigh, CCReverseNormal, CCReverseHigh, DCPositiveNormal, DCPositiveHigh
	}
	...
	public enum MultiRange {
		Range0, Range1, Range2, Range3, Voltage
	}
	...
	public enum Power03Range {
		Range0, Range1, Range2, Rang3
	}

	public enum Power03Range2 {
		Range0, Range1, Range2, Rang3
	}

	/**
	 * 膜片检测结果 正常 OR 异常
	 * @date: 2022年1月20日 上午10:47:59
	 */
	public enum CheckResultMode {
		NORMAL, EXCEPTION
	}
