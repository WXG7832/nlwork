...
/**
 * @author wavy_zheng
 * @version 创建时间：2021年12月16日 下午5:43:20 类说明
 */
public class MbMeasureChnData extends Data implements Configable, Queryable, Responsable {
	...
	public Code getCode() {
		// TODO Auto-generated method stub
		return CalBoxDeviceCode.MeasureChnCode;
	}
	...
	public String toString() {
		return "MbMeasureChnData [moduleIndex=" + moduleIndex + ", pole=" + pole + ", mode=" + mode + ", calculateDot="
				+ calculateDot + ", programDot=" + programDot + ", programKReadonly=" + programKReadonly
				+ ", programBReadonly=" + programBReadonly + ", programDotReadonly=" + programDotReadonly
				+ ", adcKReadonly=" + adcKReadonly + ", adcBReadonly=" + adcBReadonly + ", backAdcKReadonly1="
				+ backAdcKReadonly1 + ", backAdcBReadonly1=" + backAdcBReadonly1 + ", backAdcKReadonly2="
				+ backAdcKReadonly2 + ", backAdcBReadonly2=" + backAdcBReadonly2 + ", dataCount=" + dataCount
				+ ", adcDatas=" + adcDatas + "]";
	}
